    ...
    return Expanded(
        child: GridView.builder(padding: EdgeInsets.zero,
          ...
          crossAxisCount: 2, crossAxisSpacing: 4, mainAxisSpacing: 16),
              itemBuilder: (context, index) => InkWell(onTap: () => Navigator.of(context).push(MaterialPageRoute(builder: (context) => ProductDetailsScreen(productEntity: products[index]),)),child: ProductItem(productEntity: products[index])),
            ));
  }
}
